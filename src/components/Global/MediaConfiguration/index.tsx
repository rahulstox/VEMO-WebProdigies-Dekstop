...
const MediaConfiguration = ({ state, user }: Props) => {
  ...
  console.log("MediaConfiguration state:", state);
  console.log("Displays available:", state.displays?.length || 0);
  console.log("Audio inputs available:", state.audioInput?.length || 0);
